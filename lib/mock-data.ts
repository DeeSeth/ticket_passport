...
export const mockUsers: User[] = [
  {
    ...
    name: 'Jane Wang',
    passportScore: 80, // Full verification: 15 + 20 + 45
    isVerified: true,
    verification: {
      emailVerified: true,
      emailVerifiedAt: new Date('2024-03-15'),
      phoneVerified: true,
      phoneVerifiedAt: new Date('2024-03-15'),
      phone: '+1 (***) ***-1234',
      idVerified: true,
      idVerifiedAt: new Date('2024-03-16'),
  ...
  },
  {
    ...
    name: 'Dee',
    passportScore: 80, // Full verification
    isVerified: true,
    verification: {
      emailVerified: true,
      emailVerifiedAt: new Date('2024-06-01'),
      phoneVerified: true,
      phoneVerifiedAt: new Date('2024-06-01'),
      phone: '+1 (***) ***-5678',
      idVerified: true,
      idVerifiedAt: new Date('2024-06-02'),
      idType: 'passport',
    },
    membershipStatus: 'active',
    membershipExpiresAt: new Date('2026-12-31'),
  ...
  },
  {
    ...
    verification: {
      ...
      phoneVerified: true,
      phoneVerifiedAt: new Date('2024-01-20'),
      phone: '+1 (***) ***-9012',
      idVerified: true,
      idVerifiedAt: new Date('2024-01-21'),
      idType: 'national_id',
    },
    membershipStatus: 'active',
    membershipExpiresAt: new Date('2026-12-31'),
  ...
  },
  {
    ...
    name: 'Alex Chen',
    passportScore: 15, // Email only
    isVerified: false,
    verification: {
      emailVerified: true,
      emailVerifiedAt: new Date('2025-11-10'),
      phoneVerified: false,
      idVerified: false,
    },
...
export const mockTickets: Ticket[] = [
  ...
  // Additional tickets for more marketplace listings
  {
    ...
    resaleStatus: 'listed',
    resalePrice: 675,
    barcode: 'T-PASSPORT-TKT-008-VWX234',
  ...
  },
  {
    ...
    resaleStatus: 'listed',
    resalePrice: 300,
    barcode: 'T-PASSPORT-TKT-009-YZA567',
  ...
  },
  {
    ...
    isCleared: true,
    resaleStatus: 'in_auction',
    barcode: 'T-PASSPORT-TKT-010-BCD890',
  ...
  },
  {
    ...
    resaleStatus: 'listed',
    resalePrice: 250,
    barcode: 'T-PASSPORT-TKT-011-EFG123',
  ...
  },
  {
    ...
    resaleStatus: 'listed',
    resalePrice: 500,
    barcode: 'T-PASSPORT-TKT-012-HIJ456',
  ...
  },
  {
    ...
    isCleared: true,
    resaleStatus: 'in_auction',
    barcode: 'T-PASSPORT-TKT-013-KLM789',
